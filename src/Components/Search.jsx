...
const Search = () => {
  ...
  return (
    <div className='w-[100%]'>
      <div className='flex items-center h-10 bg-[#FEBD69] rounded'>
      ...
      <input className='flex grow items-center h-[100%] rounded-l 
       text-black bg-white' type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
